...
# def test_android_capabilities(appium_test_capabilities):
#     android_caps = appium_test_capabilities["android"]
#     assert android_caps["platformName"] == "Android"
#     assert "deviceName" in android_caps


# def test_ios_capabilities(appium_test_capabilities):
#     ios_caps = appium_test_capabilities["ios"]
